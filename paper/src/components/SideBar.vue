...
.sidebar a {
  ...
  color: #aaaaaa;}
.opcao:hover a, a:hover{color: #707070;}
.logo{width: 160px; height: 70px;}
.opcoes{width: 160px; height: 50px;}
.test{width: 160px; height: 150px;}
.separador{height: calc(100% - 70px);}
a.router-link-exact-active, .router-link-exact-active:hover a{color: #3586aa;}
svg{fill: #aaaaaa; margin: 0px 10px;}
.opcao:hover svg{fill: #707070;}
.router-link-exact-active svg, .router-link-exact-active:hover svg{ fill: #3586aa;}
/* Mais tarde arranjo melhor forma de escrever */
.ajuste{padding-left: 46px;}
.ajuste2{width: 90px; overflow: hidden; white-space: nowrap; text-overflow: ellipsis; text-align: left;}
.ajuste3{margin-bottom: 30px;}
</style>
