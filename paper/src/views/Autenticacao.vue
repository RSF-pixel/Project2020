    ...
    <div class="autenticacao anim-autenticacao-registo fundo-dd borda-solida borda-w05 borda-70 borda-r10 sombra-caixa">
      <div class="form-container">
        <form @submit.prevent="autenticacao">
          ...
          <input class="cor-60 fundo-fa fonte-12 opensans-l borda-r5 sem-margens" type="email" name="correio"  v-model='correio'><br>
          ...
          <button class="botao-autenticacao-registo fundo-aa borda-r5 cor-20 fonte-16 mukta-sb cursor-pointer margem-t15" type="submit"><router-link :to="{name: 'Home'}">Entrar</router-link></button>
        </form>
