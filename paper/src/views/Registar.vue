    ...
    <div class="registo anim-autenticacao-registo fundo-dd borda-solida borda-w05 borda-70 borda-r10 sombra-caixa">
      <div class="form-container">
        <form @submit.prevent="registo">
          ...
          <input class="cor-60 fundo-fa fonte-12 opensans-l borda-r5 sem-margens" type="text" name="nome" v-model='nome' required><br>
          ...
          <input class="cor-60 fundo-fa fonte-12 opensans-l borda-r5 sem-margens" type="text" name="apelido" v-model='apelido' required><br>
          ...
          <input class="cor-60 fundo-fa fonte-12 opensans-l borda-r5 sem-margens" type="text" name="correio-eletronico" v-model='correio' required><br>
          ...
          <input class="cor-60 fundo-fa fonte-12 opensans-l borda-r5 sem-margens" :type="type" name="palavra-passe" v-model='passe' required>
          ...
          <input class="cor-60 fundo-fa fonte-12 opensans-l borda-r5 sem-margens" type="number" max="8" name="numero-estudante" v-model='numero_estudante' required><br>
          ...
          <button class="botao-autenticacao-registo fundo-aa borda-r5 cor-20 fonte-16 mukta-sb cursor-pointer margem-t15" type="submit"><router-link :to="{name: 'Home'}">Criar utilizador</router-link></button>
        </form>
