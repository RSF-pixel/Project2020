    ...
    <div class="registo anim-autenticacao-registo fundo-dd borda-solida borda-w05 borda-70 borda-r10 sombra-caixa">
      <div class="form-container">
        <form @submit.prevent="registo">
          ...
          <input class="cor-60 fundo-fa fonte-12 opensans-l borda-r5 sem-margens" type="text" name="nome" v-model='utilizador.nome' required="required" autocomplete="off"><br>
          ...
          <input class="cor-60 fundo-fa fonte-12 opensans-l borda-r5 sem-margens" type="text" name="apelido" v-model='utilizador.apelido' required="required" autocomplete="off"><br>
          ...
          <b-select class="b-select-registo" name="tipo-utilizador" v-model="utilizador.tipo_utilizador" :options="$store.getters.obterTipoUtilizadores" required="required"></b-select>
          <!-- -->
